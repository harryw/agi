...
describe "chef_accounts/new.html.haml" do
  before(:each) do
    assign(:chef_account, stub_model(ChefAccount,
      :name => "MyString",
  ...
  it "renders new chef_account form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => chef_accounts_path, :method => "post" do
